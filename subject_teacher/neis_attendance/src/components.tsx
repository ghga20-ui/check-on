...
/** 체크온 brand glyph: white bell with the check knocked out, for the blue
 *  brand containers (.sb-logo / .ob-logo). Mirrors public/favicon.svg. */
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 512 512" aria-hidden="true">
      <mask id={maskId}>
        ...
        <path d="M204 244 L242 282 L314 198" fill="none" stroke="#000" strokeWidth="42" strokeLinecap="round" strokeLinejoin="round" />
      </mask>
      <path d="M256 88 C170 88 138 158 138 244 V328 L100 384 H412 L374 328 V244 C374 158 342 88 256 88 Z" fill="currentColor" mask={`url(#${maskId})`} />
